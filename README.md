...
- Emoji everywhere: type `:` + a search term in any text block or the page title for a Slack-style emoji picker (full standard emoji set, most-used emoji ranked first); the page icon uses the same searchable set
